// currency_data.dart
// Static hardcoded list of 180+ world currencies with code, name, and flag emoji.
// This ensures the currency list is always available instantly — no API call needed.
...
class CurrencyData {
  ...
  /// Returns the flag for a given currency code, or '🏳️' if not found.
  ...
  /// Returns the full name for a given currency code, or the code itself if not found.
